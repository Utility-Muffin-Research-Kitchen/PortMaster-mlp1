                          ...
                          size_t patch_count, char *err, size_t err_size)
{
    ...
    if (ok) {
        ok = fprintf(fp,
            ...
            "      \"leaf-squashfs-check\": \"compat/tools/aarch64/bin/leaf-squashfs-check\",\n"
            "      \"squashfuse\": \"compat/tools/aarch64/bin/squashfuse\",\n"
            "      \"squashfuse_libs\": \"compat/tools/aarch64/lib\"\n"
            "    }\n"
            "  },\n"
            "  \"ports_scan\": {\n"
            "    \"schema\": 1,\n"
...
static int pm_install_compat_assets(const pm_context *ctx, char *err, size_t err_size)
{
    ...
    const char *drm_files[] = { "leaf-drm-rotate.so", "manifest.json" };
