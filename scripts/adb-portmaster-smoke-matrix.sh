...
MATRIX = [
    ...
    },
    {
        ...
        "interactive": True,
        "active_timeout": 90,
        "process_regex": "retroarch|2048_libretro",
    },
    {
    ...
    },
    {
        ...
        "active_timeout": 180,
        "active_hold": 8,
        "process_regex": "box86 .*ShovelKnight|(^|[ /])ShovelKnight($| )",
    },
    {
        "category": "godot-4.3",
        "subject": "Duck Dodge",
    ...
    {
        "category": "godot-4.3-direct-sdl2",
        "subject": "Songo5",
        "script": "Roms/PORTS/Songo5.sh",
        "required": ["Roms/PORTS/songo5/runtime/sbc_4_3_rcv12", "Roms/PORTS/songo5/gamedata/Songo5.pck", "Roms/PORTS/songo5/songo5.gptk"],
        "markers": ["LEAF_PM_PORT_ENV=1", "LEAF_PM_GODOT_DIRECT_SDL2", "leaf_pm_run_godot_sdl2_runtime"],
        "log": "Roms/PORTS/songo5/log.txt",
        "interactive": True,
        "active_timeout": 120,
        "process_regex": "sbc_4_3_rcv12|Songo5[.]pck",
    },
    {
    ...
    },
    {
        ...
        "active_timeout": 240,
        "active_hold": 8,
        "process_regex": "mono .*Celeste[.]exe|Celeste[.]exe",
    },
    {
        "category": "mono-dotnet",
